...
results_mp <- read.csv('/mnt/scratch/smithfs/megan/lba/varyqO_mp/results_mp.csv', sep=",")
results_ml <- read.csv('/mnt/scratch/smithfs/megan/lba/varyqO_ml/results_ml.csv', sep=",")
...
combined_plot <- ((figure_mp_sc | figure_mp_all | figure_mp_lsd) / (figure_ml_sc | figure_ml_all | figure_ml_lsd)) + 
  plot_annotation(tag_levels = 'A')

pdf('./figures/varyqO.pdf', height=8, width=15)
combined_plot
dev.off()
