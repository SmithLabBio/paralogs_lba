...
results_mp <- read.csv('/mnt/scratch/smithfs/megan/lba/varyqr_mp_loss/results_mp.csv', sep=",")
results_ml <- read.csv('/mnt/scratch/smithfs/megan/lba/varyqr_ml_loss/results_ml.csv', sep=",")
...
pdf('./figures/varyqr_loss.pdf', height=8, width=10)
combined_plot
dev.off()
